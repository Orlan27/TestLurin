package com.zed.lurin.commons.utils.email;
...
/**
 * @deprecated this class is deprecated due to the use of the  com.zed.lurin.mail.services.IMailServices service that
 * is being worked through JavaMail of wildfly
 */
@Deprecated
public class EmailUtil {
    ...
    public static void sendEmail(Session session, String toEmail, String subject, String body){
        try
        {
        	...
        	System.out.println("EMail Sent Exception!!");
            e.printStackTrace();
        }
    }
