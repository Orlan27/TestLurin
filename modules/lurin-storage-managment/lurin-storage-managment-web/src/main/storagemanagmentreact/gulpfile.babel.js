...
gulp.task('htmlReplace', () => {
  gulp.src('index.jsp')
  .pipe(htmlReplace({ css: ['styles/bootstrap.min.css', 'styles/bootstrap-theme.min.css',
    'styles/main.css', 'styles/rc-menu.css', 'styles/react-select.min.css', 'styles/react-datepicker.css',
    'styles/toggle.css', 'styles/rc-color-picker.css'],
    js: ['js/app.js'] }))
  .pipe(gulp.dest(paths.dist));
});
