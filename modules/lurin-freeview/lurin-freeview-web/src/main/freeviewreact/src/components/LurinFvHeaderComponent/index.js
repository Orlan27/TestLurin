...
function LurinFvHeaderComponent(props) {
  return (
    ...
    <StyledHeader bsStyle="primary" currentStyles={props.currentStyles} >
      ...
      <a href="/freeview/#UserChangeData/">
      {currentUserSession}
      </a>
      </span>
      <a href="/logout"><img src="images/close-session-white.png" alt="close" />
       <span className="text-icon"><FormattedMessage id="header.button.closesession" defaultMessage="Cerrar Sessión"></FormattedMessage></span></a>
      </Col>
    </StyledHeader>
  );
}
